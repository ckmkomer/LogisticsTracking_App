...
namespace LogisticsTrackingApp.Service.Services.Concrete
{
	public class CustomerServiceWithNoCaching : Service<Customer>, ICustomerService
	{
		...
		public CustomerServiceWithNoCaching(IGenericRepository<Customer> repository, IUnitOfWork unitOfWork, IMapper mapper, ICustomerRepository customerRepository) : base(repository, unitOfWork)
		{
